/*
  ...
  Changes 10 August 2014 by Anthony King (anthonydking@slimroms.net):
    updated err and added errx
    make buildable with mingw
    make buildable as a linux binary
*/
...
int main(int argc,char *argv[])
{
	...
	if(fwrite(header,1,32,fd)!=32) err(1, "fwrite(%s)", argv[3]);
